    ...
    <div className="flex justify-center">
      <div className="flex items-center justify-between flex-1 px-10 py-5 max-w-9xl">
        ...
        <div className="flex items-center">
          <NavbarMenuDesktopDropdown title="About" linkPathnames={navbarLinksAboutPathnames}>
            <NavbarLinksAbout linkClassName="px-4 py-2 text-lg leading-8 rounded font-inter whitespace-nowrap hover:bg-dawnDark-400 hover:bg-opacity-70" />
          </NavbarMenuDesktopDropdown>
          <NavbarMenuDesktopDropdown title="Our Science" linkPathnames={navbarLinksPagesPathnames}>
